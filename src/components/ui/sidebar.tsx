...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-11 w-11 min-h-[44px] min-w-[44px] touch-feedback", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "mt-auto flex flex-col gap-2 p-3 group-data-[collapsible=icon]:p-2",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-inset ring-sidebar-ring transition-[width,height,padding,gap,justify-content] duration-200 ease-in-out hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:h-10 group-data-[collapsible=icon]:w-10 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0 md:min-h-[44px] touch-feedback",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-10 text-xs min-h-[44px]",
        lg: "h-12 text-sm min-h-[44px]",
      },
    },
    defaultVariants: {
      variant: "default",
